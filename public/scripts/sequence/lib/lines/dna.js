  ...
  DNA.prototype.draw = function(y, baseRange) {
    ...
    if(subSequence) {
      for(k = 0; k < lh.basesPerRow; k++){
        ...
        artist.text(_.isObject(character) ? character.sequence[character.position] : character, x, y + (this.baseLine === undefined ? this.height : this.baseLine),{mousemove: function(event){}});
