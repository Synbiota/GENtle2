...
@module Sequence
@submodule Views
@class SequenceChromatographView
**/
// define(function(require) {
  var template = require('../templates/sequence_edition_view.hbs'),
      SequenceChromatographCanvas = require('../lib/sequence_chromatograph_canvas'),
      ...
      Q = require('q'),
      SequenceChromatographView;

  SequenceChromatographView = Backbone.View.extend({
    manage: true,
    template: template,
...
export default SequenceChromatographView;
  // return SequenceChromatographView;
// });
